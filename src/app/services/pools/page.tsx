...
export const metadata: Metadata = {
  title: "Swimming Pool Lifeguard Services Singapore | Residential & Commercial Pool Safety | Bearded Lifeguard",
  description:
    "Professional swimming pool lifeguards in Singapore for residential condos, commercial hotels, schools & private facilities. Certified pool safety supervision with trained water rescue experts. Available island-wide.",
  keywords: [
    "swimming pool lifeguard singapore",
    "pool lifeguards singapore", 
    "pool lifeguard services sg",
    "residential pool lifeguard singapore",
    "commercial pool lifeguard sg",
    "hotel pool lifeguard singapore",
    "condo pool lifeguard services sg",
    "private pool lifeguard singapore",
    "school pool lifeguard sg", 
    "aquatic center lifeguard singapore",
    "swimming pool safety singapore",
    "pool supervision services sg",
    "certified pool lifeguards singapore",
    "professional pool safety sg",
    "swimming pool security singapore",
    "pool rescue services sg",
    "lifeguardservices pool singapore",
    "lifeguardservice pool sg",
    "sg pool lifeguard hire",
    "singapore swimming pool safety"
  ],
