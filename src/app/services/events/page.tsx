...
export const metadata: Metadata = {
  ...
  description:
    "Professional event lifeguard services in Singapore for corporate events, community festivals, sports competitions, and film productions. Experienced event safety management and aquatic supervision.",
  keywords: [
      ...
      <section className="px-4 pt-16 md:pt-20 pb-12 bg-gradient-to-br from-blue-50 to-white">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="text-xl text-[#384152] text-center max-w-3xl mx-auto mb-8">
            Make your aquatic events safe and successful with our experienced
            lifeguards. From corporate gatherings to community festivals, we
            ensure water safety so you can focus on creating memorable
            experiences.
          </p>
      ...
      <section className="px-4 py-16 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#384152] max-w-2xl mx-auto">
              We go beyond basic lifeguarding to provide comprehensive event
              support that ensures your aquatic event runs smoothly from start
              to finish.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-[#384152]">
                Pre-event consultation to assess safety requirements and develop
            ...
            <div className="text-center">
              ...
              <p className="text-[#384152]">
                From single lifeguards to full safety teams, we scale our
                service to match your event size.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#384152]">
                Full safety equipment provided including rescue boards, first
                aid stations, and communication devices.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#384152]">
                Available for early morning setups, late evening events, and
                multi-day functions.
              </p>
            </div>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#384152]">
                      We discuss your event details, venue requirements,
                      expected attendance, and specific safety needs.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#384152]">
                      If needed, we conduct a pre-event site visit to understand
                      the venue layout and identify potential risks.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#384152]">
                      We create a comprehensive safety plan including lifeguard
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#384152]">
                      Our certified lifeguards arrive early, set up equipment,
                      and provide continuous safety coverage throughout your
                      event.
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <div className="mb-6">
              ...
              <blockquote className="text-xl italic text-[#384152] leading-relaxed">
                "Bearded Lifeguard made our corporate pool party absolutely
                stress-free. Their lifeguards were professional, vigilant, and
                helped create a safe environment where our employees could truly
                enjoy themselves. Highly recommended!"
              </blockquote>
            </div>
            <div>
              <div className="font-semibold text-[#20334F]">Sarah Chen</div>
              <div className="text-[#384152] text-sm">
                HR Director, TechCorp Singapore
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 py-16 bg-gradient-to-r from-[#FF6633] to-[#e55a2b]">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Let us handle the water safety while you focus on creating an
            amazing event experience. Book now for competitive rates and
