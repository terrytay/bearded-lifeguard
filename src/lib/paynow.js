      ...
      var v = (function () {
        ...
        return (
          ...
          (d.add = function (t, o) {
            ...
            if (c === s) return d(7);
            var $ =
                ((h = {}), (h[n] = 6e4), (h[r] = 36e5), (h[e] = 1e3), h)[c] ||
                1,
              l = this.$d.getTime() + t * $;
            return D.w(l, this);
          }),
  ...
  class PaynowQR {
    ...
    generate(opts) {
        ...
        { id: "01", value: "12" }, // ID 01: Point of Initiation Method 11: static, 12: dynamic
        {
          ...
          value: [
            ...
            { id: "03", value: String(!opts.amount || opts.editable ? 1 : 0) }, // 1 = Payment amount is editable, 0 = Not Editable
            {
              id: "04",
              value: String(
                opts.expiry || dayjs_min().add(5, "year").format("YYYYMMDD")
              ),
            },
        ...
        value: [
          {
            ...
            id: "01",
            value: String(opts.refNumber || ""), // ID 01: Bill Number
          },
        ],
      };
      ...
      let str = p.reduce((final, current) => {
        ...
        final +=
          current.id +
          this.padLeft(current.value.length.toString(), 2) +
          current.value;
        return final;
      }, "");
