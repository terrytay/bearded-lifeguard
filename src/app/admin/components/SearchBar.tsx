      ...
      <div className="max-w-7xl mx-auto space-y-3">
        <div className="flex gap-2">
          ...
          <button
            onClick={onRefresh}
            disabled={isLoading}
            className="px-3.5 bg-ink text-paper rounded-xl hover:bg-signal disabled:opacity-50 transition-all flex items-center justify-center min-h-[44px] min-w-[44px]"
            aria-label="Refresh"
          >
            <ArrowPathIcon
