    ...
    <div className="space-y-3">
      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-[60]">
          <div className="bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-indigo-900/95 backdrop-blur-xl rounded-3xl max-w-md w-full p-8 shadow-2xl border border-white/20">
            <div className="text-center mb-6">
              ...
              <p className="text-white/70 leading-relaxed">
                This action is{" "}
                <span className="text-red-300 font-semibold">irreversible</span>
                . A payment confirmation email will be automatically sent to the
                customer.
              </p>
            </div>
