      ...
      <div className="page-content">
        <div className="content-wrapper">
          ...
          <div className=" text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-orange-100 border border-orange-200 text-[#FF6633] px-4 py-2 rounded-full text-sm font-medium mb-4">
              <Calendar className="w-4 h-4" />
              Professional Lifeguard Booking
            </div>
            <h1 className="text-4xl md:text-5xl font-bold text-modern-primary mb-4">
              Book Your Lifeguard
            </h1>
            <p className="text-lg text-modern-secondary max-w-2xl mx-auto">
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-gray-600">
                    Please fill in your information and select your preferred
                    time slots.
                  </p>
                </div>
