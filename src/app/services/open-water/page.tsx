...
export const metadata: Metadata = {
  ...
  description:
    "Expert open water lifeguard services in Singapore for beaches, reservoirs, sporting events and film productions. Specialized open water safety management with professional rescue equipment and certified Safety Managers.",
  keywords: [
      ...
      <section className="px-4 pt-16 md:pt-20 pb-12 bg-gradient-to-br from-blue-50 via-cyan-50 to-white">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="text-xl text-[#384152] text-center max-w-3xl mx-auto mb-8">
            Singapore's premier open water safety specialists. From beaches and
            reservoirs to sporting events and film productions, our certified
            open water lifeguards provide unmatched expertise in challenging
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#384152] max-w-2xl mx-auto">
              Open water environments present unique challenges requiring
              specialized training, equipment, and experience. Our team delivers
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-[#384152]">
                Specialized open water lifeguard certifications with advanced
                rescue training.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#384152]">
                Dedicated Safety Managers oversee complex operations with
            ...
            <div className="text-center">
              ...
              <p className="text-[#384152]">
                Deep knowledge of Singapore's waters, currents, weather
            ...
            <div className="text-center">
              ...
              <p className="text-[#384152]">
                Coordinated multi-lifeguard teams with rescue craft and
      ...
      <section className="px-4 py-16 bg-white">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-[#384152] max-w-2xl mx-auto">
              From Singapore's pristine beaches to challenging reservoir
              environments, we provide safety coverage across diverse open water
              locations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100">
              ...
              <h3 className="text-xl font-bold text-[#20334F] mb-3">
                Beaches & Coastlines
              </h3>
              ...
              <div className="bg-blue-100 rounded-lg p-3 text-xs text-blue-800">
                <strong>Expertise:</strong> Tide awareness, beach patrol
                techniques, surf conditions, and crowd management.
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-2xl p-8 border border-green-100">
              ...
              <div className="bg-green-100 rounded-lg p-3 text-xs text-green-800">
                <strong>Expertise:</strong> Freshwater rescue techniques, varied
                depths, limited visibility, and access challenges.
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-8 border border-orange-100">
              ...
              <div className="bg-orange-100 rounded-lg p-3 text-xs text-orange-800">
                <strong>Expertise:</strong> Advanced rescue techniques,
                specialized equipment, and comprehensive emergency planning.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
              <h3 className="text-2xl font-bold text-[#20334F] mb-6">
                Sporting Events
              </h3>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-[#384152]">
                    Open water swimming races, marathons, and triathlon swim
                    legs with comprehensive safety coverage.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#20334F] mb-2">
                  ...
                  <p className="text-sm text-[#384152]">
                    Kayaking, sailing, dragon boat racing, and other water
                    sports competitions requiring safety oversight.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#20334F] mb-2">
                  ...
                  <p className="text-sm text-[#384152]">
                    Athletic training sessions, swim squads, and specialized
                    water sports training programs.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-[#384152]">
                    Movie shoots, TV productions, documentaries, and commercial
                    filming requiring water safety expertise.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#20334F] mb-2">
                  ...
                  <p className="text-sm text-[#384152]">
                    Fashion shoots, product photography, and artistic projects
                    in challenging open water environments.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#20334F] mb-2">
                  ...
                  <p className="text-sm text-[#384152]">
                    Brand campaigns, promotional videos, and social media
                    content requiring safety supervision.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#384152]">
                      Comprehensive evaluation of water conditions, access
                      points, potential hazards, and emergency evacuation
                      routes.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#20334F] mb-2">
                      Equipment & Team Deployment
                    </h3>
                    <p className="text-[#384152]">
                      Strategic positioning of rescue craft, safety equipment,
                      and communication systems with trained personnel.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#384152]">
                      Active surveillance of all water activities with immediate
                      response capability and coordination with emergency
                      services.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#384152]">
                      Complete operational oversight from pre-event briefing
                      through post-event debriefing and reporting.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 bg-blue-50 rounded-xl p-6">
                ...
                <p className="text-blue-700 text-sm">
                  Every open water operation includes a dedicated Safety Manager
                  who coordinates all aspects of water safety, ensuring seamless
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gray-50 rounded-2xl">
              <h3 className="text-lg font-bold text-[#20334F] mb-4">
                Rescue Craft
              </h3>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            <div className="text-center mb-6">
              ...
              <blockquote className="text-lg italic text-[#384152] leading-relaxed mb-4">
                "Bearded Lifeguard's open water team provided exceptional safety
                coverage for our international triathlon at East Coast. Their
                Safety Manager coordinated seamlessly with race officials, and
                their rescue craft operators were positioned perfectly.
                Professional, reliable, and absolutely essential for our event
                success."
              </blockquote>
              <div>
                <div className="font-semibold text-[#20334F]">Marcus Lim</div>
                <div className="text-[#384152] text-sm">
                  Race Director, Singapore International Triathlon
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="px-4 py-16 bg-gradient-to-r from-blue-600 to-cyan-600">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Trust Singapore's open water specialists for your next challenging
            aquatic event. Comprehensive planning, professional execution,
            absolute safety.
          </p>
          ...
          <div className="mt-8 text-white/80 text-sm">
            <p>
              • Dedicated Safety Managers • Professional rescue equipment •
